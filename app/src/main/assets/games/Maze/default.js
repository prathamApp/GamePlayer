...
function handleTouchMove(evt) {
  //alert('in move');
   ...
   //console.log(''+moves);
	...
	requestAnimationFrame(maze.redraw);    	
...
function setimages()
{
  ...
  document.body.style.backgroundImage="url("+Utils.Path+"images/background.jpg)";
...
function onLoad() {
  ...
  canvasDiv1.addEventListener("keydown", onKeyDown);
